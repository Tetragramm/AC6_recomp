...
void ApplyAc6FixDefaults() {
    ...
    // draw_resolution_scale_x/y directly: the combined resolution_scale cvar
    // (what the settings menu writes) leaves those two at 1, so reading them
    // alone left the fixes off for everyone who scaled that way.
